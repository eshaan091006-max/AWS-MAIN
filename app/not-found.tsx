...
export default function NotFound() {
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 pt-28 pb-20">
      <div className="max-w-md w-full text-center space-y-6 p-8 rounded-xl bg-navy-900/80 border border-aws-orange/30 backdrop-blur-xl shadow-2xl">
        <div className="w-16 h-16 rounded-xl bg-aws-orange/15 border border-aws-orange/30 flex items-center justify-center mx-auto text-aws-orange shadow-lg shadow-aws-orange/10">
