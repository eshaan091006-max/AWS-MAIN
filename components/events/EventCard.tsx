      ...
      >
        ...
        <div className={cn("flex flex-col flex-1 p-5", featured && "lg:p-8 lg:justify-center")}>
          ...
          <Link href={`/events/${event.slug}`} className="mt-2">
            <h3
              className={cn(
                "font-display font-black text-white leading-snug transition-colors group-hover:text-aws-orange",
          ...
          <div className="mt-5 flex items-center gap-2">
            {registrationClosed ? (
              <Link
                ...
                className="flex-1 py-2.5 px-4 rounded-full border border-white/10 bg-white/[0.04] text-zinc-300 hover:text-white hover:bg-white/[0.07] text-xs font-semibold text-center transition-all"
              >
                Recap
              </Link>
            ) : isRegistered ? (
              ...
              <div className="flex-1 py-2.5 px-4 rounded-full border border-white/10 bg-white/[0.04] text-zinc-500 text-xs font-semibold text-center inline-flex items-center justify-center gap-1.5">
            ...
            <Link
              ...
              className="p-2.5 rounded-full border border-white/10 bg-white/[0.04] text-zinc-400 hover:text-aws-orange hover:border-aws-orange/40 transition-all shrink-0"
            >
